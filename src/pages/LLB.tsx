...
const LLB = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const res = await fetch(`${API}/api/academic/program/LLB`);
      ...
      <main className="flex-1">
        ...
        <div className="border-b bg-secondary/30">
          <div className="container flex items-center gap-2 py-4 text-sm text-muted-foreground">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="font-bold text-gold uppercase tracking-wider text-[11px]">03 Year LL.B.</span>
          </div>
        </div>

        {/* Hero Section */}
        <section className="relative bg-primary py-24 overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80')] opacity-20 bg-cover bg-center" />
          ...
          <div className="container relative z-10">
            <div className="max-w-3xl space-y-6">
              ...
              >
                03 Year <span className="text-gold">LL.B.</span>
              </motion.h1>
              <motion.div 
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x border-x md:border-x-0">
            <div className="p-8 text-center space-y-3 group hover:bg-gold/5 transition-colors">
              ...
              <div>
                ...
                <h3 className="text-2xl font-serif font-bold text-navy">3 Years</h3>
              </div>
            </div>
            <div className="p-8 text-center space-y-3 group hover:bg-gold/5 transition-colors">
              <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-2xl bg-gold/10 text-gold group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <h3 className="text-2xl font-serif font-bold text-navy">144 Credits</h3>
              </div>
            </div>
            <div className="p-8 text-center space-y-3 group hover:bg-gold/5 transition-colors">
              <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-2xl bg-gold/10 text-gold group-hover:scale-110 transition-transform">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              >
                ...
                <div className="prose prose-lg text-muted-foreground leading-relaxed italic">
                  The University offers Three Year LL.B. Course. Students are required to complete 144 credits before they become eligible to graduate. Each credit course involves 60 hours of classroom teaching.
                </div>
                <div className="bg-white p-8 rounded-3xl border shadow-sm space-y-6">
                  ...
                  <ul className="space-y-4">
                    {[
                      "Comprehensive Three-Year LL.B. Program",
                      "Industry-aligned Dynamic Curriculum",
                      "Clinical Papers for Practical Training",
                      "Specialized Electives for legal specialization",
              ...
              >
                ...
                <div className="bg-navy p-8 rounded-3xl text-white shadow-xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10 flex gap-6">
                    ...
                    <div className="space-y-4">
                      <h4 className="text-xl font-bold font-serif text-gold tracking-tight">DET Admission</h4>
                      <p className="text-white/80 leading-relaxed font-medium">
                        DET (DSNLU ENTRANCE TEST) as regards eligibility criteria. Admission to the Three Year LL.B. course is based on the performance in the entrance test conducted by the University.
                      </p>
                    </div>
                  </div>
                </div>
