...
const CENTRE_ID = 16;
const CENTRE_NAME = "Banking and Finance Law & Policy";

const BankingFinanceCentre = () => {
      ...
      <main className="flex-1">
        ...
        <div className="border-b bg-secondary/50">
          <div className="container flex items-center gap-2 py-4 text-sm text-muted-foreground">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="font-medium text-gold">{CENTRE_NAME}</span>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            ...
            >
              ...
              <div className="flex justify-end gap-4 pt-4 border-t">
                <button onClick={() => setShowModal(false)} className="px-4 py-2 text-muted-foreground">Cancel</button>
                <button onClick={handleSave} className="bg-[#0f2d5c] text-white px-6 py-2 rounded font-bold">Save</button>
              </div>
            </motion.div>
          </div>
        )}
...
export default BankingFinanceCentre;
